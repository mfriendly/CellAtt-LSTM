...
class Model(nn.Module):
    ...
    def __init__(self, configs, patch_len=16, stride=8):
        ...
        print("Patching and embedding using .unfold")
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
       ...
       # print("Normalization from Non-stationary Transformer")
        ...
        # permute before patching and embedding
        x_enc = x_enc.permute(0, 2, 1)
        # [bs, n_vars, seq_len]
        # u: [bs * nvars x patch_num x d_model]  # 틀림: 이 시점에서는 아직 patching 전
